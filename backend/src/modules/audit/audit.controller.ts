...
export class AuditController {
  ...
  @ApiQuery({ name: 'entityName', required: false, type: String, description: 'Filter by entity name' })
  ...
  @ApiQuery({ name: 'limit', required: false, type: Number, description: 'Maximum number of logs to return (default: 50)' })
